        ...
        <AnimatedArticle>
            ...
            {frontmatter.logo && (
                <Image
                    ...
                    width={120}
                    height={120}
                    className="w-15 h-15 object-cover rounded-md mx-auto mb-4 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900"
                    priority
                />
            )}
            <h1 className="text-4xl font-bold mb-2 text-center">{frontmatter.name}</h1>
