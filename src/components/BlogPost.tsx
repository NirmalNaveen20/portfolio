    ...
    return (
        <Link href={`/blog/${slug}`} className="block group h-full">
            <motion.div
                ...
                className="flex flex-col h-full group border rounded-xl p-4 shadow-sm hover:border-blue-500 hover:shadow-md transition-all duration-300 cursor-pointer bg-gray-100 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-800"
            >
                {/* Title */}
                ...
                {/* Summary */}
                <p className="text-gray-700 dark:text-gray-300 mt-1 line-clamp-3 flex-1">
                    {summary}
                </p>
